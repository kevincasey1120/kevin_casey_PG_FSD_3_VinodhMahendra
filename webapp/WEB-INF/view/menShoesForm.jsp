...
<body
	...
	style="background-image: url('${pageContext.request.contextPath}/images/menShoesBack.jpg');  background-repeat: no-repeat;  background-attachment: fixed;  background-size: 100% 100%;">
	<%@include file="homeHeader.jsp"%>

	
	<a align="center" style="text-decoration:none; font-family: sans-serif; color: blue; font-weight:bold; font-size: 44px;">Mens - Shoe Department - </a>
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
	<a align="center" style="text-decoration:none; font-family: sans-serif; color: red; font-weight:bold; font-size: 50px;" class="blink"><i>All LEATHER SHOES are 25% OFF!!!</i></a>
