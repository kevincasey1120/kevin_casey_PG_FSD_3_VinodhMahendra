...
<body
	...
	style="background-image: url('${pageContext.request.contextPath}/images/girlsShoesBack.jpg');  background-repeat: no-repeat;  background-attachment: fixed;  background-size: 100% 100%;">
	<%@include file="homeHeader.jsp"%>

	
	<a align="center" style="text-decoration:none; font-family: sans-serif; color: blue; font-weight:bold; font-size: 44px;">Girls - Shoe Department - </a>
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
	<a align="center" style="text-decoration:none; font-family: sans-serif; color: red; font-weight:bold; font-size: 50px;" class="blink"><i>All  RED SHOES are 1/2 OFF!!!</i></a>
	...
	<table>
		...
		<tr>
			<c:forEach items="${girlshoeData}" var="fss">
