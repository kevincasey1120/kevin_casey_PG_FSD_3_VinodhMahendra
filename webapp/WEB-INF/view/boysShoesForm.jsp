...
<body
	...
	style="background-image: url('${pageContext.request.contextPath}/images/boysShoesBack.jpg');  background-repeat: no-repeat;  background-attachment: fixed;  background-size: 100% 100%;">
	<%@include file="homeHeader.jsp"%>

	
	<a align="center" style="text-decoration:none; font-family: sans-serif; color: blue; font-weight:bold; font-size: 44px;">Boys - Shoe Department - </a>
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
	...
	<table>
		...
		<tr>
			<c:forEach items="${boyshoeData}" var="fss">
