...
<body>
	<%@include file="adminHeader.jsp"%>
		<form name="addProductform" action="updatetoNewproduct" onsubmit="return addUserValidationForm()">
			...
			Product Category :
				...
				<input type="radio" id="men" name="weartype" value="Mens_Wear">	<label for="men">Mens Wear</label><br> 
				
				<input type="radio"	id="women" name="weartype" value="Womens_Wear"> <label for="women">Womens Wear</label> <br> 
				
				<input type="radio"	id="boys" name="weartype" value="Boys_Wear"> <label	for="boys">Boys Wear</label> <br> 
				
				<input type="radio"	id="girls" name="weartype" value="Girls_Wear"> <label	for="girls">Girls Wear</label> <br> 
